...
<div id="mensaje"></div>
 ...
 <div class="row">
      ...
      <!-- INICIO FORM DE REGISTAR NUEVAS INSTITUCIONES PERSONALIZADO -->
               {!! Form::model($carr_ins, ['method' => 'put', 'role' => 'form', 'url' => ['carreras_instituciones/update-new', $carr_ins]]) !!}
                    ...
                    <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="form-group {{ $errors->has('institucion_id') ? 'has-error' : '' }}">
                                  ...
                                  {!! Form::select('institucion_id', $Instituciones, (Input::old('institucion_id')),array('class'=>'form-control','name'=>'institucion_id','id'=>'institucion_id')) !!}
                                </div>
                              </div>
                              <div class="col-md-1">
