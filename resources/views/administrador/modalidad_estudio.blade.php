...
<div id="mensaje"></div>
 ...
 <div class="row">
      <div class="col-md-12">
      <!-- INICIO FORM DE REGISTAR NUEVAS MODALIDADES PERSONALIZADO -->
              {!! Form::open(array('method' => 'post', 'role' => 'form', 'url' => 'modalidad_estudio/grabar-new')) !!}
                <div class="box box-success box-solid">
                  <div class="box-header with-border">
                    <h3 class="box-title">REGISTRAR NUEVAS MODALIDADES</h3>
                  ...
                  <div class="box-body">
                    <div class="row">
                        ...
                        <form class="" role="form" method="POST" action=" ">
                              ...
                              <div class="col-md-8">
                                <div class="form-group {{ $errors->has('modalidades_txt') ? 'has-error' : '' }}">
                                  {!! Form::label('modalidades_lbl','Ingrese nombre de la Modalidad')  !!}
                                  {!! Form::text('modalidades_txt', (Input::old('modalidades_nombre')),array('class'=>'form-control','name'=>'modalidades_nombre','id'=>'modalidades_nombre')) !!}
                                </div>
                              </div>
                              <div class="col-md-1">
            ...
            <div class="col-md-12">
              <div class="box box-info">
                <div class="box-header" align="center">
                  <h1 class="box-title">Lista de Modalidades</h1>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($moda as $mod)
                                  <tr>  
                                    ...
                                    <td class="mailbox-name">{{ $mod->nombre }}</td>
                                    <td class="mailbox-date">{{ $mod->created_at }}</td>
                                    <td class="mailbox-date">{{ $mod->updated_at }}</td>
                                    <td><a type="button" href="{{route('modalidad_estudio.edit', $mod->id )}}" class="btn btn-xs btn-warning btn-updated">Actualizar</a></td>
                                  </tr>
