...
<div id="mensaje"></div>
 ...
 <div class="row">
      ...
      <!-- INICIO FORM DE REGISTAR NUEVAS INSTITUCIONES PERSONALIZADO -->
              {!! Form::model($ins, ['method' => 'put', 'role' => 'form', 'url' => ['instituciones/update-new', $ins]]) !!}
                <div class="box box-success box-solid">
                  <div class="box-header with-border">
                    <h3 class="box-title">ACTUALIZAR INSTITUCIONES</h3>
                    ...
                    <div class="row">
                              ...
                              <div class="col-md-3">
                                <div class="form-group {{ $errors->has('tipo_id') ? 'has-error' : '' }}">
                                  ...
                                  {!! Form::select('tipo_id', $tipos, (Input::old('tipo_id')),array('class'=>'form-control','name'=>'tipo_id','id'=>'tipo_id')) !!}
                                </div>
                              </div>
                              <div class="col-md-1">
