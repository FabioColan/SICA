...
<div id="mensaje"></div>
 ...
 <div class="row">
      ...
      <!-- INICIO FORM DE REGISTAR NUEVAS FACULTAD PERSONALIZADO -->
              {!! Form::open(array('method' => 'post', 'role' => 'form', 'url' => 'ciclo_upci/grabar-new')) !!}
                <div class="box box-success box-solid">
                  <div class="box-header with-border">
                    <h3 class="box-title">REGISTRAR NUEVOS CICLOS</h3>
                  ...
                  <div class="box-body">
                    <div class="row">
                        ...
                        <form class="" role="form" method="POST" action=" ">
                              ...
                              <div class="col-md-8">
                                <div class="form-group {{ $errors->has('ciclos_upci_txt') ? 'has-error' : '' }}">
                                  {!! Form::label('ciclos_upci_lbl','Ingrese Ciclo de la UPCI')  !!}
                                  {!! Form::text('ciclos_upci_txt', (Input::old('ciclos_upci_nombre')),array('class'=>'form-control','name'=>'ciclos_upci_nombre','id'=>'ciclos_upci_nombre')) !!}
                                </div>
                              </div>
                              <div class="col-md-1">
            ...
            <div class="col-md-12">
              <div class="box box-info">
                <div class="box-header" align="center">
                  <h1 class="box-title">Lista de Ciclos de la UPCI</h1>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                ...
                                @foreach ($cicl as $cil)
                                  <tr>  
                                    ...
                                    <td class="mailbox-name">{{ $cil->nombre }}</td>
                                    <td class="mailbox-date">{{ $cil->created_at }}</td>
                                    <td class="mailbox-date">{{ $cil->updated_at }}</td>
                                    <td><a type="button" href="{{route('ciclo_upci.edit', $cil->id )}}" class="btn btn-xs btn-warning btn-updated">Actualizar</a></td>
                                  </tr>
